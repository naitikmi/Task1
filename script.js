document.getElementById("show").addEventListener("click", function() {
    document.getElementById("createform1").style.display = "block";
});

document.getElementById("close-form").addEventListener("click", function(){
    document.getElementById("createform1").style.display = "none";
...
document.getElementById("joingroup").addEventListener("click",function(){
    ...
    document.getElementById("leavegroup").style.display="inline";
    document.getElementById("listgroupdiv").style.display="inline";
})

document.getElementById("leavegroup").addEventListener("click",function(){
    document.getElementById("leavegroup").style.display="none";
    document.getElementById("joingroup").style.display="inline";
    document.getElementById("listgroupdiv").style.display="none";
})
